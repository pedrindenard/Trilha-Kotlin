...
class ListaTransacoesAdapter(transacoes: List<Transacao>,
    ...
    override fun getView(posicao: Int, view: View?, parent: ViewGroup?): View {
        ...
        viewCriada.transacao_valor.text = transacao
                .valor.formataParaBrasileiro()
        viewCriada.transacao_categoria.text = transacao
                .categoria.limitaEmAte(limiteDaCategoria)
        viewCriada.transacao_data.text = transacao
                .data.formataParaBrasileiro()
